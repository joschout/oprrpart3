...
public class RoboRally<Board, Robot, Wall, Battery> extends JFrame {
	...
	public static void main(String[] args) {
		...
		/* <begin> */
		RoboRally<roboRallyPackage.Board, roboRallyPackage.gameElementClasses.Robot, roboRallyPackage.gameElementClasses.Wall, roboRallyPackage.gameElementClasses.Battery> roboRally 
			= new RoboRally<roboRallyPackage.Board, roboRallyPackage.gameElementClasses.Robot, roboRallyPackage.gameElementClasses.Wall, roboRallyPackage.gameElementClasses.Battery>(new roboRallyPackage.guiClasses.Facade());
		/* <end> */
